...
<x:xmpmeta xmlns:x="adobe:ns:meta/">
  <rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
    ...
    <rdf:Description xmlns:dc="http://purl.org/dc/elements/1.1/" rdf:about="">
      ...
      <dc:title>
        <rdf:Alt>
          <rdf:li xml:lang="x-default">{{.Supplier}}: Invoice {{.Number}}</rdf:li>
        </rdf:Alt>
      </dc:title>
      <dc:creator>
        <rdf:Seq>
          <rdf:li>{{.Supplier}}</rdf:li>
        </rdf:Seq>
      </dc:creator>
      <dc:description>
        <rdf:Alt>
          <rdf:li xml:lang="x-default">Invoice {{.Number}} dated {{.Date.Format "2006-01-02"}} issued by {{.Supplier}}</rdf:li>
        </rdf:Alt>
      </dc:description>
      {{- end}}
    </rdf:Description>
    <rdf:Description xmlns:pdf="http://ns.adobe.com/pdf/1.3/" rdf:about="">
      <pdf:Producer>{{.PDFProducer}}</pdf:Producer>
    </rdf:Description>
{{- if true}}
    <rdf:Description xmlns:xmp="http://ns.adobe.com/xap/1.0/" rdf:about="">
      <xmp:CreatorTool>{{.CreatorTool}}</xmp:CreatorTool>
      <xmp:CreateDate>{{.Invoice.Date.Format "2006-01-02T15:04:05Z07:00"}}</xmp:CreateDate>
      <xmp:ModifyDate>{{.Invoice.Date.Format "2006-01-02T15:04:05Z07:00"}}</xmp:ModifyDate>
    </rdf:Description>
{{- end}}
    ...
    <rdf:Description xmlns:fx="urn:factur-x:pdfa:CrossIndustryDocument:invoice:1p0#" rdf:about="">
      ...
      <fx:ConformanceLevel>{{.Invoice.ProfileName}}</fx:ConformanceLevel>
    </rdf:Description>
  </rdf:RDF>
</x:xmpmeta>
<?xpacket end="w"?>
