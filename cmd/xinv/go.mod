module github.com/knieriem/xinv/cmd/xinv

go 1.25.0

require (
	github.com/knieriem/text v0.12.0
	github.com/knieriem/xinv v0.0.0
)

replace github.com/knieriem/xinv => ../..
...
require (
	...
	github.com/invopop/gobl v0.401.0 // indirect
	github.com/invopop/gobl.cii v0.35.0 // indirect
